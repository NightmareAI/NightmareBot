...
async Task<string> GPT3Announce(string prompt, string server, string channel, string username)
{
    try
    {
        var gptPrompt = $"You are NightmareBot, a bot on the {server} Discord server that generates nightmarish art. You have just completed a piece of art titled \"{prompt}\" for the user {username} in the {channel} channel. Please generate a funny, sarcastic, or weird description:";
