...
if (Directory.Exists("/result/pixray"))
{
    ...
    embed.WithImageUrl($"https://dumb.dev/nightmarebot-output/{id}/output.png").WithTitle(prompt).WithDescription("Generated by pixray");
...
else if (Directory.Exists("/result/swinir"))
{
    ...
    var embed = new EmbedBuilder();
    embed.WithImageUrl($"https://dumb.dev/nightmarebot-output/{id}/output.png").WithTitle(prompt).WithDescription("Enhanced with SwinIR");
...
else if (Directory.Exists("/result/majesty"))
{
    ...
    var embed = new EmbedBuilder();    
    embed.WithImageUrl($"https://dumb.dev/nightmarebot-output/{id}/{filename}").WithTitle(prompt).WithDescription("Generated with majesty-diffusion");
...
else if (Directory.Exists("/result/latent-diffusion"))
{
    ...
    var embed = new EmbedBuilder();
    embed.WithImageUrl($"https://dumb.dev/nightmarebot-output/{id}/{Path.GetFileName(gridImage)}").WithTitle(prompt).WithDescription("Generated with latent-diffusion");
...
else if (Directory.Exists("/result/enhance"))
{
    ...
    var embed = new EmbedBuilder();
    embed.WithImageUrl($"https://dumb.dev/nightmarebot-output/{id}/{file}").WithTitle(prompt).WithDescription("Enhanced with Real-ESRGAN");
